...
const catalogCourseDefinitions: CatalogCourseDefinition[] = [
  {
    ...
    includes: [
      ...
      'Разбор ознакомительного доступа к первым урокам и открытия полного доступа после оплаты по QR СБП и ручной проверки',
  ...
  },
  {
    ...
    includes: [
      ...
      '2 первых урока до оплаты и полный доступ после оплаты по QR СБП и ручной проверки',
