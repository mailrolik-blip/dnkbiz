...
```text
СЃРґРµР»Р°Р№ РєР°СЂС‚РёРЅРєСѓ РґР»СЏ РјРѕРЅРѕРїРѕР»РёРё РёСЃС‚РѕСЂРёСЏ Р·РЅР°РєРѕРјСЃС‚РІР°
```

Expected:

- bot replies `РџСЂРёРЅСЏР», СЃРѕР±РёСЂР°СЋ РєР°СЂС‚РёРЅРєСѓ...`
...
1. Press `вњЏпёЏ РўРµРєСЃС‚`.
2. Send:

```text
РїРѕРјРµРЅСЏР№ С‚РµРєСЃС‚ РЅР° РќРћР’Р«Р™ РЎРџРћРЎРћР‘ РћРџР›РђРўР«
```

Expected:

- bot replies `РџСЂРёРЅСЏР» РїСЂР°РІРєСѓ, РїРµСЂРµСЃРѕР±РёСЂР°СЋ РєР°СЂС‚РёРЅРєСѓ...`
...
- `РќРѕРІС‹Р№ РІР°СЂРёР°РЅС‚` is a placeholder.
...
`PNG Р±РµР· СЃР¶Р°С‚РёСЏ` sends the current output through Telegram `sendDocument`.
`РЎР»РѕРё ZIP` exports the current layered job to `.storage/visual_layer_packs/` and sends the ZIP as a document.
...
The bot now supports manual layer placement revisions without regeneration:

- `?? Текст` + `увеличь текст`, `текст левее`, `текст ниже`
- `Дед/персонаж` + `увеличь деда`, `деда вправо`, `деда вниз`
- `Композиция` + `дед справа, текст слева как в примере`
